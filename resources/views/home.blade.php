...
=======
<<<<<<<< HEAD:resources/views/posts.blade.php
            class="bg-white border-2 border-black rounded-lg shadow mx-auto max-w-none px-4 py-5 sm:px-6 space-y-3">
            @csrf
...
>>>>>>>> b336812c9bf254e5ec7d1c26dcacd36303707f94:resources/views/home.blade.php
...
<<<<<<<< HEAD:resources/views/posts.blade.php
                    ...
                    <div class="py-4 text-gray-700 font-normal space-y-2">
                        <img src="{{ asset('./images/' . $user->post_image ?? 'https://via.placeholder.com/150') }}"
                            class="min-h-auto w-full rounded-lg object-cover max-h-64 md:max-h-72" alt="" />
                        {{-- {{ dd($user) }} --}}
                        <p>{{ $user->post_content }}</p>
========
